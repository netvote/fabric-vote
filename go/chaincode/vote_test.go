...
func TestVoteChaincode_Invoke_AddPrivateBallotWithDecisions(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":["us","ga","123"],"DecisionIdToVoteCount":{"transaction-id":{"test-id":1}},"DecisionTimestamps":{"transaction-id":{"test-id":[]}},"LastVoteTimestampSeconds":0,"Attributes":null}`)

	checkInvoke(t, stub, "assign_ballot", []string{`{"BallotId":"transaction-id2","Voter":{"Id":"slanders"}}`})
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":["us","ga","123"],"DecisionIdToVoteCount":{"transaction-id":{"test-id":1},"transaction-id2":{"test-id":1}},"DecisionTimestamps":{"transaction-id":{"test-id":[]},"transaction-id2":{"test-id":[]}},"LastVoteTimestampSeconds":0,"Attributes":null}`)
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":["us","ga","123"],"DecisionIdToVoteCount":{"transaction-id":{"test-id":0},"transaction-id2":{"test-id":1}},"DecisionTimestamps":{"transaction-id":{"test-id":[100]},"transaction-id2":{"test-id":[]}},"LastVoteTimestampSeconds":100,"Attributes":null}`)
...
func TestVoteChaincode_Invoke_AddBallotWithDecisions(t *testing.T){
	...
	checkState(t, stub, "test/BALLOT/transaction-id", `{"Id":"transaction-id","Name":"Nov 8, 2016","Decisions":["test-id"],"Private":false,"Attributes":null,"Description":""}`)
	...
	checkQuery(t, stub, "get_admin_ballot", []string{`{"Id":"transaction-id"}`}, `{"Ballot":{"Id":"transaction-id","Name":"Nov 8, 2016","Decisions":["test-id"],"Private":false,"Attributes":null,"Description":""},"Decisions":[{"Id":"test-id","Name":"What is your decision?","BallotId":"transaction-id","Options":[{"Id":"a","Name":"A","Attributes":{"image":"/url"}}],"Attributes":{"Key":"Value"},"ResponsesRequired":1,"RepeatVoteDelaySeconds":0,"Repeatable":false}]}`)
...
func TestVoteChaincode_Invoke_TestMultipleAllocates(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"transaction-id":{"test-id":1}},"DecisionTimestamps":{"transaction-id":{"test-id":[]}},"LastVoteTimestampSeconds":0,"Attributes":null}`)

	//cast votes
	mockTime(100)
	checkInvoke(t, stub, "cast_votes", []string{`{"VoterId":"slanders", "BallotId":"transaction-id", "Decisions":[{"DecisionId":"test-id", "Selections": {"a":1}}]}`})
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"transaction-id":{"test-id":0}},"DecisionTimestamps":{"transaction-id":{"test-id":[100]}},"LastVoteTimestampSeconds":100,"Attributes":null}`)
...
func TestVoteChaincode_Invoke_AddVoter(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/voter-id", `{"Id":"voter-id","Dimensions":["us","ga","123"],"DecisionIdToVoteCount":{"ballotId":{"d1":2,"d2":1}},"DecisionTimestamps":null,"LastVoteTimestampSeconds":0,"Attributes":null}`)
...
func TestVoteChaincode_Invoke_CastVote(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"transaction-id":{"test-id":0}},"DecisionTimestamps":{"transaction-id":{"test-id":[500]}},"LastVoteTimestampSeconds":500,"Attributes":null}`)
...
func TestVoteChaincode_Invoke_CastVoteMultiBallot(t *testing.T) {
	...
	checkState(t, stub, "test/BALLOT/transaction-id", `{"Id":"transaction-id","Name":"Nov 8, 2016","Decisions":["test-id"],"Private":false,"Attributes":null,"Description":""}`)
	checkInvokeTX(t, stub, "transaction-id", "init_voter", []string{`{"Id":"slanders"}`})
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"otherballot":{"test-id2":1},"transaction-id":{"test-id":1}},"DecisionTimestamps":{"otherballot":{"test-id2":[]},"transaction-id":{"test-id":[]}},"LastVoteTimestampSeconds":0,"Attributes":null}`)
	...
	checkQuery(t, stub, "get_voter_ballots", []string{`{"Id":"slanders"}`}, `[{"Id":"otherballot","Name":"Nov 8, 2016","Decisions":["test-id2"],"Private":false,"Attributes":null,"Description":""},{"Id":"transaction-id","Name":"Nov 8, 2016","Decisions":["test-id"],"Private":false,"Attributes":null,"Description":""}]`)

	mockTime(500)

	checkInvoke(t, stub, "cast_votes", []string{`{"VoterId":"slanders", "BallotId":"transaction-id", "Decisions":[{"DecisionId":"test-id", "Selections": {"a":1}}]}`})
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"otherballot":{"test-id2":1},"transaction-id":{"test-id":0}},"DecisionTimestamps":{"otherballot":{"test-id2":[]},"transaction-id":{"test-id":[500]}},"LastVoteTimestampSeconds":500,"Attributes":null}`)
	...
	checkQuery(t, stub, "get_voter_ballots", []string{`{"Id":"slanders"}`}, `[{"Id":"otherballot","Name":"Nov 8, 2016","Decisions":["test-id2"],"Private":false,"Attributes":null,"Description":""}]`)

	mockTime(1000)
	checkInvoke(t, stub, "cast_votes", []string{`{"VoterId":"slanders", "BallotId":"otherballot", "Decisions":[{"DecisionId":"test-id2", "Selections": {"a":1}}]}`})
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"otherballot":{"test-id2":0},"transaction-id":{"test-id":0}},"DecisionTimestamps":{"otherballot":{"test-id2":[1000]},"transaction-id":{"test-id":[500]}},"LastVoteTimestampSeconds":1000,"Attributes":null}`)
	checkState(t, stub, "test/RESULTS/transaction-id/test-id", `{"Id":"test-id","Results":{"ALL":{"a":1}}}`)
...
func TestVoteChaincode_Invoke_CastRepeatableVote(t *testing.T){
	...
	checkState(t, stub, "test/BALLOT/transaction-id", `{"Id":"transaction-id","Name":"","Decisions":["test-id"],"Private":false,"Attributes":null,"Description":""}`)
	checkInvokeTX(t, stub, "transaction-id", "init_voter", []string{`{"Id":"slanders"}`})
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"transaction-id":{"test-id":1}},"DecisionTimestamps":{"transaction-id":{"test-id":[]}},"LastVoteTimestampSeconds":0,"Attributes":null}`)
	checkState(t, stub, "test/ACCOUNT_BALLOTS/test", `{"Id":"test","PublicBallotIds":{"transaction-id":true},"PrivateBallotIds":{}}`)
	mockTime(500)
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"transaction-id":{"test-id":1}},"DecisionTimestamps":{"transaction-id":{"test-id":[500]}},"LastVoteTimestampSeconds":500,"Attributes":null}`)
	checkState(t, stub, "test/RESULTS/transaction-id/test-id", `{"Id":"test-id","Results":{"ALL":{"a":1}}}`)
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"transaction-id":{"test-id":1}},"DecisionTimestamps":{"transaction-id":{"test-id":[500,1500]}},"LastVoteTimestampSeconds":1500,"Attributes":null}`)
...
func TestVoteChaincode_Invoke_QueryBallotResults(t *testing.T){
	...
	checkState(t, stub, "test/BALLOT/transaction-id", `{"Id":"transaction-id","Name":"Nov 8, 2016","Decisions":["test-id","test-id2"],"Private":false,"Attributes":null,"Description":""}`)
	checkState(t, stub, "test/DECISION/transaction-id/test-id", TEST_DECISION_JSON)
	checkState(t, stub, "test/RESULTS/transaction-id/test-id", `{"Id":"test-id","Results":{}}`)
...
func TestVoteChaincode_Invoke_InitVoterWithAttributes(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"transaction-id":{"test-id":1}},"DecisionTimestamps":{"transaction-id":{"test-id":[]}},"LastVoteTimestampSeconds":0,"Attributes":{"key":"val"}}`)
}