...
func TestVoteChaincode_Invoke_AddDecisionWithBallot(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"test-id":1},"LastVoteTimestampNS":0,"Props":null}`)
...
func TestVoteChaincode_Invoke_TestMultipleAllocates(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"test-id":0},"LastVoteTimestampNS":100,"Props":null}`)
...
func TestVoteChaincode_Invoke_AddPrivateBallot(t *testing.T){
	...
	checkInvokeTX(t, stub, "transaction-id", "init_voter", []string{`{"Id":"slanders"}`})
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{},"LastVoteTimestampNS":0,"Props":null}`)
...
func TestVoteChaincode_Invoke_AddVoter(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/voter-id", `{"Id":"voter-id","Dimensions":["us","ga","123"],"DecisionIdToVoteCount":{"d1":2,"d2":1},"LastVoteTimestampNS":0,"Props":null}`)
...
func TestVoteChaincode_Invoke_CastVote(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"test-id":0},"LastVoteTimestampNS":500,"Props":null}`)
...
func TestVoteChaincode_Invoke_CastRepeatableVote(t *testing.T){
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"test-id":1},"LastVoteTimestampNS":500,"Props":null}`)
	checkState(t, stub, "test/RESULTS/test-id", `{"Id":"test-id","Results":{"ALL":{"a":1}}}`)
...
func TestVoteChaincode_Invoke_InitVoterWithProps(t *testing.T) {
	...
	checkState(t, stub, "test/VOTER/slanders", `{"Id":"slanders","Dimensions":[],"DecisionIdToVoteCount":{"test-id":1},"LastVoteTimestampNS":0,"Props":{"key":"val"}}`)
}